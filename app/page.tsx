...
export default function ConsolePage() {
  ...
  const {
    ...
    // Multi-group state
    groups: layoutGroups,
    activeGroupId: storeActiveGroupId,
    groupOrder,
  ...
  useEffect(() => {
    ...
    if (groupSessions.length > 0) {
      switchSession(groupSessions[0].id);
    }
  }, [activeId, activeGroupId, sessions, switchSession]);
  ...
  }, [activeGroupId, activeSession, sessions, switchSession]);
                ...
                >
                  <ErrorBoundary>
                    <ConsoleLayout
                      ...
                      onRename={session ? (label) => renameSession(session.id, label) : undefined}
                      groupId={gid}

...
export default function UsagePage() {
  ...
  const [provider, setProvider] = useState<ConfigProvider | null>(null);
  ...
  const availableProviders = getAllSessionProviders();
  ...
  const windowSourceText =
    activePreset === "block"
      ...
      : activePreset === "week"
        ? "Week boundaries come from live usage when available, otherwise your saved week-start settings."
        : activePreset === "custom"
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="ml-auto flex items-center gap-2">
                ...
                <Select
                  value={provider ?? "all"}
                  onValueChange={(next) =>
                    setProvider(next === "all" ? null : (next as ConfigProvider))
                  }
                >

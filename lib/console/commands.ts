...
export const COMMAND_REGISTRY: CommandDef[] = [
  ...
  // Config commands
  {
    ...
    details:
      "Navigates to the Settings page where you can configure model providers, permissions, MCP servers, and other application preferences.",
    category: "config",
    handler: "navigation",
    route: "/settings?tab=core",
  },
  {
    name: "model",
  ...
  },
  {
    ...
    details:
      "Navigates to the Hooks page. Hooks are shell commands that run automatically in response to events like session start, tool calls, or notifications.",
    category: "config",
    handler: "navigation",
    route: "/hooks",
    providers: ["claude"],
  },
  {
    ...
    category: "config",
    handler: "navigation",
    route: "/hooks?action=new-hook",
    providers: ["claude"],
  },
  {
    name: "add-dir",
    description: "Add additional project directories",
    details:
      "Adds extra directories to the current Claude session so tools can read and edit files there. Use this when your task spans multiple repositories or sibling folders.",
    category: "config",
    handler: "server",
    providers: ["claude"],
  },
  {
    ...
    category: "config",
    handler: "navigation",
    route: "/settings?tab=claude&section=permissions",
  },
  {
    name: "mcp",
  ...
  {
    name: "bug",
    description: "Report an issue to Anthropic",
    details:
      "Opens Claude Code's bug reporting flow so you can send diagnostics and issue details to Anthropic.",
    category: "info",
    handler: "server",
    providers: ["claude"],
  },
  {
    ...
    details:
      "Starts Claude authentication in the terminal and links this CLI install to your Anthropic account.",
    category: "config",
    handler: "server",
    providers: ["claude"],
  },
  {
    ...
    details:
      "Removes local Claude authentication for this CLI install.",
    category: "config",
    handler: "server",
    providers: ["claude"],
  },
  {
    ...
    details:
      "Asks Claude to review changes and provide focused feedback before you ship.",
    category: "tools",
    handler: "server",
    providers: ["claude"],
  },
  {
    ...
    details:
      "Asks Claude to analyze PR comments and help resolve requested changes quickly.",
    category: "tools",
    handler: "server",
    providers: ["claude"],
  },
  {
    name: "terminal-setup",
    description: "Improve terminal compatibility",
    details:
      "Runs Claude's terminal setup helper to configure shell integration and compatibility settings.",
    category: "config",
    handler: "server",
    providers: ["claude"],
  },
  {
    ...
    details:
      "Enables or disables Vim-style keybindings in Claude's interactive interface.",
    category: "config",
    handler: "server",
    providers: ["claude"],
  },

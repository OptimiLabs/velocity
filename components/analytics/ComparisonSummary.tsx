  ...
  return (
    <Card className="bg-card">
      <CardHeader className="pb-2">
        <CardTitle className="text-section-title">Comparison Summary</CardTitle>
      </CardHeader>
      <CardContent>
        <p className="mb-2 text-[10px] text-muted-foreground">
          Change values are calculated as{" "}
          <span className="text-foreground">{periodALabel}</span>
          {" "}relative to{" "}
          <span className="text-foreground">{periodBLabel}</span>.
        </p>
        <table className="table-readable w-full table-fixed">
          <colgroup>
            <col className="w-[30%]" />
            <col className="w-[22%]" />
            <col className="w-[22%]" />

...
export function GettingStarted({ onNavigate }: GettingStartedProps) {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: "Build reusable skills",
      tab: "general",
    },
    {
      icon: <Server size={16} />,
      label: "Add an MCP server",
      desc: "Extend your assistant with custom tools",
      tab: "mcp",
    },
    {
      icon: <Shield size={16} />,
      label: "Configure permissions",
      desc: "Control what tools can run",
      tab: "permissions",
    },
  ];
  ...
  return (
    <div className="relative border border-primary/20 bg-primary/5 rounded-xl p-4 space-y-3">
      ...
      <p className="text-xs text-muted-foreground">
        Customize your provider setup to fit your workflow.
      </p>

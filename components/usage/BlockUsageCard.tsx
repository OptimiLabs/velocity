          ...
          <Card className="bg-card">
            ...
            <CardContent>
              <div className="space-y-3">
                {data.models.map((m) => {
                  const mCostResult = calculateCostDetailed(
                    m.model,
                    m.inputTokens,
                    m.outputTokens,
                    m.cacheReadTokens,
                  ...
                  const mCost = mCostResult.cost;
                  const allModelsCost = data.models.reduce((sum, item) => {
                    const result = calculateCostDetailed(
                      item.model,
                      item.inputTokens,
                      item.outputTokens,

          ...
          <div className="flex justify-between items-start gap-2">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              <button
                  ...
                  const ok = await confirm({
                    ...
                    description:
                      isCompressed
                        ...
                        : "This hides the session from active views without deleting data. You can restore it later, and analytics/cost metrics stay intact.",
                    confirmLabel: isCompressed ? "Restore" : "Compress",
                    variant: "default",
                  });
                  if (!ok) return;
                  if (isCompressed) {
                    ...
                    compressSession.mutate(session.id);
                  }
                }}
                ...
                title={isCompressed ? "Restore session" : "Compress session"}
              >
                {isCompressed ? <RotateCcw size={12} /> : <Archive size={12} />}
              </button>
              <button
                onClick={async (e) => {
                  e.preventDefault();

...
import { Sparkles, Loader2, Wrench, Server, Puzzle, ChevronRight } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const CLAUDE_AGENT_MODELS: Array<{ value: string; label: string }> = [
  { value: "opus", label: "opus" },
  { value: "sonnet", label: "sonnet" },
  { value: "haiku", label: "haiku" },
];
const CODEX_AGENT_MODELS: Array<{ value: string; label: string }> = [
  { value: "gpt-5.3-codex", label: "gpt-5.3-codex" },
  { value: "gpt-5.2-thinking", label: "gpt-5.2-thinking" },
  { value: "gpt-5.2-pro", label: "gpt-5.2-pro" },
  { value: "codex-mini-latest", label: "codex-mini-latest" },
];
const GEMINI_AGENT_MODELS: Array<{ value: string; label: string }> = [
  { value: "gemini-3-pro", label: "gemini-3-pro" },
  { value: "gemini-3-flash", label: "gemini-3-flash" },
  { value: "gemini-3-deep-think", label: "gemini-3-deep-think" },
  { value: "gemini-2.5-pro", label: "gemini-2.5-pro" },
...
export function AgentBuilder({
  ...
  const runtimeModelOptions = useMemo(() => {
    ...
    const options: Array<{ value: string; label: string }> = [
      { value: "__auto__", label: "Auto (provider default)" },
      ...base,
    ];

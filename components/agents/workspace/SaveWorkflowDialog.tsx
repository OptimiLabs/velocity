...
export function SaveWorkflowDialog({
  ...
  useEffect(() => {
    ...
    setCwd(existingCwd || "");
  }, [open, existingName, existingDescription, existingCwd]);
    ...
    const nodes: WorkflowNode[] = canvasNodes
      ...
      .map((cn) => {
        ...
        return {
          ...
          agentName,
          model: existingNode?.model ?? agent?.model,
          effort: existingNode?.effort ?? agent?.effort,
      ...
      <DialogContent className="sm:max-w-[420px]">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Save this canvas as a reusable workflow.
          </DialogDescription>
        </DialogHeader>

...
import { Wrench, Server, Puzzle, Ban, ChevronRight } from "lucide-react";
import {
  AGENT_ICON_MAP,
...
const PROVIDER_MODELS: Record<ConfigProvider, string[]> = {
  claude: [...MODELS],
  codex: ["gpt-5.3-codex", "gpt-5.2-thinking", "gpt-5.2-pro", "codex-mini-latest"],
  gemini: [
    "gemini-3-pro",
    "gemini-3-flash",
    "gemini-3-deep-think",
                        ...
                        return (
                          ...
                          >
                            {isMcp ? (
                              ...
                              <Puzzle size={9} className="text-chart-4" />
                            )}
                            {tool.name}
                          </button>
                        );

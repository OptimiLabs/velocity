        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {isEditing ? (
                <div className="flex items-center gap-2 mt-1">
                  {visibility === "global" ? (
                    <>
                      <Globe size={13} className="text-chart-5" />
                    ...
                    <>
                      <FolderGit2 size={13} className="text-chart-2" />
                      <span className="text-xs text-muted-foreground">
                  ...
                  {visibility === "project" && (
                    <div className="space-y-2">
                      ...
                      {selectedProjectPath && !showBrowse && (
                        <div className="flex items-center gap-2 px-2.5 py-2 rounded-md border border-chart-2/30 bg-chart-2/5">
                                ...
                                {projects
                                  ...
                                  .map((p) => (
                                    <button
                                      ...
                                      className="w-full text-left px-2.5 py-1.5 rounded hover:bg-muted/50 transition-colors group/item"
                                    >
                                      ...
                                      <div className="text-meta text-text-tertiary font-mono truncate ml-5 mt-0.5">
                                        {shortenPath(p.path)}
                                      </div>
                                    </button>
                                  ))}
            ...
            <div>
              ...
              {!isEditing && (
                <p className="text-meta text-text-tertiary mt-1">
                  This becomes the slash command: /{name || "skill-name"}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              />
              <p className="text-meta text-text-tertiary mt-1">
                What it does + when to use it + trigger phrases. Claude reads
                this to decide whether to load the skill.
              </p>
            </div>

...
interface RoutingState {
  ...
  // Active provider filter for routing graph
  activeProvider: ConfigProvider | "all";
  setActiveProvider: (p: ConfigProvider | "all") => void;
...
export const useRoutingStore = create<RoutingState>()((set) => ({
  ...
  activeProvider: "all",
  setActiveProvider: (activeProvider) => set({ activeProvider, graphScope: "all" }),
